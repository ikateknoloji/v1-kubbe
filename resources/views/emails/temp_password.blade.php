...
<head>
  ...
  <![endif]-->
    ...
    <title>Üyelik oluşturuldu</title>
  <style>
...
<body class="m-0 p-0 w-full [word-break:break-word] [-webkit-font-smoothing:antialiased] bg-slate-50">
  ...
  <div role="article" aria-roledescription="email" aria-label="Üyelik oluşturuldu" lang="en">
          ...
          <table class="w-full" cellpadding="0" cellspacing="0" role="none">
            <tr>
              <td class="p-12 sm:px-6 text-base text-slate-700 bg-white rounded shadow-sm">
                <h1 class="m-0 mb-6 text-4xl sm:leading-8 text-black font-semibold">
                  Merhaba,
                </h1>
                ...
                <p class="m-0 leading-6">
                 Hoş Geldiniz!
                  <br>
                  <br>
                  Müşteri yönetim sisteminizde müşteri kaydınız başarıyla oluşturulmuştur. Size verdiğimiz geçici şifreyi kullanarak 
                  panel girişini yapabilir ve yeni şifre oluşturabilirsiniz.
                 </p>
...
<div>
  <a href="/" class="inline-block py-4 px-6 text-base leading-none font-semibold rounded text-slate-50 bg-indigo-700 [text-decoration:none] mb-10">
    <!--[if mso]>
    ...
    <![endif]-->
                ...
                <p class="m-0">
                 Lütfen ilk girişinizi yaptıktan sonra güvenliğiniz için şifrenizi değiştiriniz.
                  <br>
                  <br>
                  Herhangi bir sorunuz olursa bizimle iletişime geçmekten çekinmeyin.
                  <br>
                  <br>
                  Teşekkürler, <br> Kubbe Ajans
                </p>
              </td>
            </tr>
            <tr role="separator">
